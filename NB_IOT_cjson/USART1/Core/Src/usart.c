...
char *QMTSUB = "QMTRECV";
char *send_data = "5555551555";
char *Motor_Forward =  "Forward";
char *Motor_Left = "Left";
char *Motor_Right = "Right";
...
//
    ...
    if(huart->Instance == USART2)
    {
		...
		if(strstr((const char*)Usart2type.Usart2RecBuff,QMTSUB)!= NULL)
		{
		   if(strstr((const char*)Usart2type.Usart2RecBuff,send_data)!= NULL)
		   {
              send_data_flag = 1;
		   }	
//		   if(strstr((const char*)Usart2type.Usart2RecBuff,Motor_Forward)!= NULL)
//		   {
//			 xSemaphoreGiveFromISR(semphore_handle, &xHigherPriorityTaskWoken);
//			 Motor_Data = 3;
//		   }
//		   if(strstr((const char*)Usart2type.Usart2RecBuff,Motor_Left)!= NULL)
//		   {
//			 xSemaphoreGiveFromISR(semphore_handle, &xHigherPriorityTaskWoken);
//			  Motor_Data = 1; 
//		   }
//		   if(strstr((const char*)Usart2type.Usart2RecBuff,Motor_Right)!= NULL)
//		   {
//			  xSemaphoreGiveFromISR(semphore_handle, &xHigherPriorityTaskWoken);
//			  Motor_Data = 2; 
//		   }
